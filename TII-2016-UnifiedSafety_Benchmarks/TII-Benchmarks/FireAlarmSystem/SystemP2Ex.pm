...
module a1_actuators
    ...
    [t] (s_a1_actuators=0) & (s_fail_a1=0) & ((trigger_controller & alarm_controller)) -> (s_a1_actuators'=1) & (update_a1_actuators'=true) & (isSound_a1_actuators' = true);
    [t] (s_a1_actuators=1) & (s_fail_a1=0) & ((trigger_controller & (alarm_controller = false))) -> (s_a1_actuators'=0) & (update_a1_actuators'=true) & (isSound_a1_actuators' = false);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_a1_actuators=0) & (s_fail_a1=0) & (((trigger_controller = false) | (alarm_controller = false))) -> (s_a1_actuators'=0) & (update_a1_actuators'=false);
    [t] (s_a1_actuators=1) & (s_fail_a1=0) & (((trigger_controller = false) | (alarm_controller = true))) -> (s_a1_actuators'=1) & (update_a1_actuators'=false);
    [t] (s_a1_actuators=0) & (s_fail_a1=1) -> (s_a1_actuators'=0) & (update_a1_actuators'=false) & (isSound_a1_actuators' = false);
    [t] (s_a1_actuators=1) & (s_fail_a1=1) -> (s_a1_actuators'=0) & (update_a1_actuators'=false);
endmodule
...
module v1_actuators
    ...
    [t] (s_v1_actuators=0) & (s_fail_v1=0) & ((trigger_controller & sprinkle_controller)) -> (s_v1_actuators'=1) & (update_v1_actuators'=true) & (isOpen_v1_actuators' = true);
    [t] (s_v1_actuators=1) & (s_fail_v1=0) & ((trigger_controller & (sprinkle_controller = false))) -> (s_v1_actuators'=0) & (update_v1_actuators'=true) & (isOpen_v1_actuators' = false);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_v1_actuators=0) & (((s_fail_v1=1) | (trigger_controller = false) | (sprinkle_controller = false))) -> (s_v1_actuators'=0) & (update_v1_actuators'=false);
    [t] (s_v1_actuators=1) & (((s_fail_v1=1) | (trigger_controller = false) | (sprinkle_controller = true))) -> (s_v1_actuators'=1) & (update_v1_actuators'=false);
endmodule
...
module d0_sensors
    ...
    [t] (s_d0_sensors=0) & (s_fail_d0=0) & ((incident0_sim_sensors = true)) -> (s_d0_sensors'=1) & (output_d0_sensors'=true) & (detected_d0_sensors' = true);
    [t] (s_d0_sensors=1) & (s_fail_d0=0) & ((doReset_iReset = true)) -> (s_d0_sensors'=0) & (output_d0_sensors'=true) & (detected_d0_sensors' = false);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_d0_sensors=0) & ((incident0_sim_sensors = false) | (s_fail_d0=1)) -> (s_d0_sensors'=0) & (output_d0_sensors'=false);
    [t] (s_d0_sensors=1) & ((doReset_iReset = false) | (s_fail_d0=1)) -> (s_d0_sensors'=1) & (output_d0_sensors'=false);
endmodule
...
module d1_sensors
    ...
    [t] (s_d1_sensors=0) & (s_fail_d1=0) & ((incident1_sim_sensors = true)) -> (s_d1_sensors'=1) & (output_d1_sensors'=true) & (detected_d1_sensors' = true);
    [t] (s_d1_sensors=1) & (s_fail_d1=0) & ((doReset_iReset = true)) -> (s_d1_sensors'=0) & (output_d1_sensors'=true) & (detected_d1_sensors' = false);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_d1_sensors=0) & ((incident1_sim_sensors = false) | (s_fail_d1=1)) -> (s_d1_sensors'=0) & (output_d1_sensors'=false);
    [t] (s_d1_sensors=1) & ((doReset_iReset = false) | (s_fail_d1=1)) -> (s_d1_sensors'=1) & (output_d1_sensors'=false);
endmodule
...
module d2_sensors
    ...
    [t] (s_d2_sensors=0) & (s_fail_d2=0) & ((incident2_sim_sensors = true)) -> (s_d2_sensors'=1) & (output_d2_sensors'=true) & (detected_d2_sensors' = true);
    [t] (s_d2_sensors=1) & (s_fail_d2=0) & ((doReset_iReset = true)) -> (s_d2_sensors'=0) & (output_d2_sensors'=true) & (detected_d2_sensors' = false);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_d2_sensors=0) & ((incident2_sim_sensors = false) | (s_fail_d2=1)) -> (s_d2_sensors'=0) & (output_d2_sensors'=false);
    [t] (s_d2_sensors=1) & ((doReset_iReset = false) | (s_fail_d2=1)) -> (s_d2_sensors'=1) & (output_d2_sensors'=false);
endmodule
...
module controller
    ...
    sprinkle_controller : bool init false;
    needsReset_controller : bool init false;

    [t] (s_controller=-1) -> (s_controller'=0) & (trigger_controller'=false) & (alarm_controller' = ((detected_d0_sensors | detected_d1_sensors) | detected_d2_sensors)) & (sprinkle_controller' = (((detected_d0_sensors & detected_d1_sensors) | (detected_d0_sensors & detected_d2_sensors)) | (detected_d1_sensors & detected_d2_sensors))) & (needsReset_controller' = ((detected_d0_sensors | detected_d1_sensors) | detected_d2_sensors));
    [t] (s_controller=0) & (s_fail_plc=0) & ((needsReset_controller = false)) -> (s_controller'=0) & (trigger_controller'=false) & (alarm_controller' = ((detected_d0_sensors | detected_d1_sensors) | detected_d2_sensors)) & (sprinkle_controller' = (((detected_d0_sensors & detected_d1_sensors) | (detected_d0_sensors & detected_d2_sensors)) | (detected_d1_sensors & detected_d2_sensors))) & (needsReset_controller' = ((detected_d0_sensors | detected_d1_sensors) | detected_d2_sensors));
    [t] (s_controller=0) & (s_fail_plc=0) & ((needsReset_controller = true)) -> (s_controller'=1) & (trigger_controller'=true);
    [t] (s_controller=1) & (s_fail_plc=0) &  ((doReset_iReset = true)) -> (s_controller'=0) & (trigger_controller'=false) & (alarm_controller' = ((detected_d0_sensors | detected_d1_sensors) | detected_d2_sensors)) & (sprinkle_controller' = (((detected_d0_sensors & detected_d1_sensors) | (detected_d0_sensors & detected_d2_sensors)) | (detected_d1_sensors & detected_d2_sensors))) & (needsReset_controller' = ((detected_d0_sensors | detected_d1_sensors) | detected_d2_sensors));

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_controller=1) & (s_fail_plc=0) & ((doReset_iReset = false)) -> (s_controller'=1) & (trigger_controller'=false);
    [t] (s_controller=0) & (s_fail_plc=1) -> (alarm_controller'=false) & (sprinkle_controller'= false) & (needsReset_controller'=false) & (trigger_controller'= false);
    [t] (s_controller=1) & (s_fail_plc=1) -> (s_controller'=0);
endmodule
...
module fail_d0
    s_fail_d0 : [0..1] init 0;
    
    [t] (s_fail_d0=0) -> 1-1.561E-11 : (s_fail_d0'=0) + 1.561E-11 : (s_fail_d0'=1);
    [t] (s_fail_d0=1) -> (s_fail_d0'=1);
endmodule


module fail_d1
    s_fail_d1 : [0..1] init 0;
    
    [t] (s_fail_d1=0) -> 1-1.561E-11 : (s_fail_d1'=0) + 1.561E-11 : (s_fail_d1'=1);
    [t] (s_fail_d1=1) -> (s_fail_d1'=1);
endmodule


module fail_d2
    s_fail_d2 : [0..1] init 0;
    
    [t] (s_fail_d2=0) -> 1-1.561E-11 : (s_fail_d2'=0) + 1.561E-11 : (s_fail_d2'=1);
    [t] (s_fail_d2=1) -> (s_fail_d2'=1);
endmodule


module fail_a1
    s_fail_a1 : [0..1] init 0;
    
    [t] (s_fail_a1=0) -> 1-6.342E-10 : (s_fail_a1'=0) + 6.342E-10 : (s_fail_a1'=1);
    [t] (s_fail_a1=1) -> (s_fail_a1'=1);
endmodule


module fail_v1
    s_fail_v1 : [0..1] init 0;
    
    [t] (s_fail_v1=0) -> 1-2.019E-11 : (s_fail_v1'=0) + 2.019E-11 : (s_fail_v1'=1);
    [t] (s_fail_v1=1) -> (s_fail_v1'=1);
endmodule

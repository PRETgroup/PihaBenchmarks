...
module compFI_1
    ...
    [t] (s_compFI_1=0) & (s_fail_1 = 0) & (update_valve = true) -> (s_compFI_1'=1) & (output_compFI_1'=true) & (oValue_compFI_1' = isOpen_valve);
    [t] (s_compFI_1=1) & (s_fail_1 = 0) & (update_valve = true) -> (s_compFI_1'=1) & (output_compFI_1'=true) & (oValue_compFI_1' = isOpen_valve);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_compFI_1=0) & (s_fail_1 = 0) & (update_valve = false) -> (s_compFI_1'=0) & (output_compFI_1'=false);
    [t] (s_compFI_1=1) & (s_fail_1 = 0) & (update_valve = false) -> (s_compFI_1'=1) & (output_compFI_1'=false);
    
    //Failure effect
    [t] (s_fail_1 = 1) -> (output_compFI_1'=false);
endmodule
...
module compFI_2
    ...
    [t] (s_compFI_2=0) & (s_fail_2 = 0) & (update_valve = true) -> (s_compFI_2'=1) & (output_compFI_2'=true) & (oValue_compFI_2' = isOpen_valve);
    [t] (s_compFI_2=1) & (s_fail_2 = 0) & (update_valve = true) -> (s_compFI_2'=1) & (output_compFI_2'=true) & (oValue_compFI_2' = isOpen_valve);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_compFI_2=0) & (s_fail_2 = 0) & (update_valve = false) -> (s_compFI_2'=0) & (output_compFI_2'=false);
    [t] (s_compFI_2=1) & (s_fail_2 = 0) & (update_valve = false) -> (s_compFI_2'=1) & (output_compFI_2'=false);
    [t] (s_fail_2 = 0) -> (output_compFI_2'=false);
endmodule
...
module valve
    ...
    [t] (s_valve=0) & (s_valveFailure=0) & ((trigger_controller & valveCtl_controller)) -> (s_valve'=1) & (update_valve'=true) & (isOpen_valve' = true);
    [t] (s_valve=1) & (s_valveFailure=0) & ((trigger_controller & (valveCtl_controller = false))) -> (s_valve'=0) & (update_valve'=true) & (isOpen_valve' = false);
    
    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_valve=0) & (((s_valveFailure=1) | (trigger_controller = false) | (valveCtl_controller = false))) -> (s_valve'=0) & (update_valve'=false);
    [t] (s_valve=1) & (((s_valveFailure=1) | (trigger_controller = false) | (valveCtl_controller = true))) -> (s_valve'=1) & (update_valve'=false);
endmodule
...
module cylinder
    ...
    [t] (s_cylinder=0) & (s_ptFailure=0) & (((output_flow_1oo2 = false) | (isOpen_valve = false))) -> (s_cylinder'=0) & (update_cylinder'=true) & (pressure_cylinder' = (pressure_cylinder < 990) ? (pressure_cylinder + 10) : pressure_cylinder);
    [t] (s_cylinder=0) & (s_ptFailure=0) & ((output_flow_1oo2 & isOpen_valve)) -> (s_cylinder'=1) & (update_cylinder'=true) & (pressure_cylinder' = (pressure_cylinder > 10) ? (pressure_cylinder - 10) : 0);
    [t] (s_cylinder=1) & (s_ptFailure=0) & ((isOpen_valve = true)) -> (s_cylinder'=1) & (update_cylinder'=true) & (pressure_cylinder' = (pressure_cylinder > 10) ? (pressure_cylinder - 10) : 0);
    [t] (s_cylinder=1) & (s_ptFailure=0) & ((isOpen_valve = false)) -> (s_cylinder'=0) & (update_cylinder'=true) & (pressure_cylinder' = (pressure_cylinder < 990) ? (pressure_cylinder + 10) : pressure_cylinder);
    
    //created for failure effect extension
    [t] (s_cylinder=0) & (s_ptFailure=1) -> (s_cylinder'=0) & (update_cylinder'=true) & (pressure_cylinder'=0);
    [t] (s_cylinder=1) & (s_ptFailure=1) -> (s_cylinder'=0);
endmodule
...
module controller
    ...
    [t] (s_controller=0) & (s_plcFailure=0) & ((update_cylinder & (pressure_cylinder > PARAM_threshold_controller))) -> (s_controller'=1) & (trigger_controller'=true) & (valveCtl_controller' = true);
    [t] (s_controller=2) & (s_plcFailure=0) & ((update_cylinder & (pressure_cylinder <= PARAM_threshold_controller))) -> (s_controller'=0) & (trigger_controller'=true) & (valveCtl_controller' = false) & (warning_controller' = false);
    [t] (s_controller=1) & (s_plcFailure=0) -> (s_controller'=2) & (trigger_controller'=false) & (warning_controller' = (oValue_flow_1oo2 = false));
    [t] (s_controller=2) & (s_plcFailure=0) & (((update_cylinder = false) | (pressure_cylinder > PARAM_threshold_controller))) -> (s_controller'=2) & (trigger_controller'=false) & (warning_controller' = (oValue_flow_1oo2 = false));
    
    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_controller=0) & (s_plcFailure=0) & (((update_cylinder = false) | (pressure_cylinder <= PARAM_threshold_controller))) -> (s_controller'=0) & (trigger_controller'=false);
    [t] (s_plcFailure=1) -> (trigger_controller'=false) & (valveCtl_controller'=false) & (warning_controller'=false);
endmodule
...
module fail_1
    ...
    [t] (s_fail_1=0) -> 1-2.022E-11 : (s_fail_1'=0) + 2.022E-11 : (s_fail_1'=1);
    [t] (s_fail_1=1) -> (s_fail_1'=1);
endmodule
...
module fail_2
    ...
    [t] (s_fail_2=0) -> 1-2.022E-11 : (s_fail_2'=0) + 2.022E-11 : (s_fail_2'=1);
    [t] (s_fail_2=1) -> (s_fail_2'=1);
endmodule


module valveFailure
    s_valveFailure : [0..1] init 0;
    
    [t] (s_valveFailure=0) -> 1-2.019E-11 : (s_valveFailure'=0) + 2.019E-11 : (s_valveFailure'=1);
    [t] (s_valveFailure=1) -> (s_valveFailure'=1);
endmodule


module plcFailure
    s_plcFailure : [0..1] init 0;
    
    [t] (s_plcFailure=0) -> 1-2.778E-12 : (s_plcFailure'=0) + 2.778E-12 : (s_plcFailure'=1);
    [t] (s_plcFailure=1) -> (s_plcFailure'=1);
endmodule


module ptFailure
    s_ptFailure : [0..1] init 0;
    
    [t] (s_ptFailure=0) -> 1-5.686E-11 : (s_ptFailure'=0) + 5.686E-11 : (s_ptFailure'=1);
    [t] (s_ptFailure=1) -> (s_ptFailure'=1);
endmodule

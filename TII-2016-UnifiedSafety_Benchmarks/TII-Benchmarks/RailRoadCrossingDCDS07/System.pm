...
module crossing
    ...
    [t] (s_crossing=0) & ((snd_d1_transmit = true)) -> (s_crossing'=1) & (closed_crossing'=true);
    [t] (s_crossing=1) & ((snd_d2_transmit = true)) -> (s_crossing'=0) & (closed_crossing'=false);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_crossing=0) & ((snd_d1_transmit = false)) -> (s_crossing'=0) & (closed_crossing'=false);
    [t] (s_crossing=1) & ((snd_d2_transmit = false)) -> (s_crossing'=1) & (closed_crossing'=false);
endmodule
...
module train
    ...
    [t] (s_train=2) & ((snd_d0_recieve = false) & (secureCounter_train >= 5)) -> (s_train'=3) & (brake_train'=true) & (close_train'=false) & (open_train'=false) & (secure_train'=false);
    ...
    [t] (s_train=4) & ((snd_d1_recieve = false) & (closeCounter_train >= 5)) -> (s_train'=3) & (brake_train'=true) & (close_train'=false) & (open_train'=false) & (secure_train'=false);
...
module signal
    ...
    [t] (s_signal=0) & ((snd_d0_transmit = true)) -> (s_signal'=1) & (secured_signal'=true);
    [t] (s_signal=1) & ((snd_d2_transmit = true)) -> (s_signal'=0) & (secured_signal'=false);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_signal=0) & ((snd_d0_transmit = false)) -> (s_signal'=0) & (secured_signal'=false);
    [t] (s_signal=1) & ((snd_d2_transmit = false)) -> (s_signal'=1) & (secured_signal'=false);
endmodule
...
module transmit
    ...
    [t] (s_transmit=0) & ((secure_train = true)) -> (s_transmit'=1) & (snd_d0_transmit'=true) & (snd_d1_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=0) & ((secure_train = false) & (close_train = true)) -> (s_transmit'=2) & (snd_d1_transmit'=true) & (snd_d0_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=0) & ((secure_train = false) & (close_train = false) & (open_train = true)) -> (s_transmit'=3) & (snd_d2_transmit'=true) & (snd_d0_transmit'=false) & (snd_d1_transmit'=false);
    [t] (s_transmit=1) & ((secure_train = false) & (close_train = true)) -> (s_transmit'=2) & (snd_d1_transmit'=true) & (snd_d0_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=2) & ((secure_train = false) & (close_train = false) & (open_train = true)) -> (s_transmit'=3) & (snd_d2_transmit'=true) & (snd_d0_transmit'=false) & (snd_d1_transmit'=false);
    [t] (s_transmit=1) & ((secure_train = false) & (close_train = false) & (open_train = true)) -> (s_transmit'=3) & (snd_d2_transmit'=true) & (snd_d0_transmit'=false) & (snd_d1_transmit'=false);
    [t] (s_transmit=1) & ((secure_train = true)) -> (s_transmit'=1) & (snd_d0_transmit'=true) & (snd_d1_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=3) & ((secure_train = false) & (close_train = false) & (open_train = true)) -> (s_transmit'=3) & (snd_d2_transmit'=true) & (snd_d0_transmit'=false) & (snd_d1_transmit'=false);
    [t] (s_transmit=2) & ((secure_train = false) & (close_train = true)) -> (s_transmit'=2) & (snd_d1_transmit'=true) & (snd_d0_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=2) & ((secure_train = true)) -> (s_transmit'=1) & (snd_d0_transmit'=true) & (snd_d1_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=3) & ((secure_train = false) & (close_train = true)) -> (s_transmit'=2) & (snd_d1_transmit'=true) & (snd_d0_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=3) & ((secure_train = true)) -> (s_transmit'=1) & (snd_d0_transmit'=true) & (snd_d1_transmit'=false) & (snd_d2_transmit'=false);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_transmit=0) & ((secure_train = false) & (close_train = false) & (open_train = false)) -> (s_transmit'=0) & (snd_d0_transmit'=false) & (snd_d1_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=1) & ((secure_train = false) & (close_train = false) & (open_train = false)) -> (s_transmit'=1) & (snd_d0_transmit'=false) & (snd_d1_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=2) & ((secure_train = false) & (close_train = false) & (open_train = false)) -> (s_transmit'=2) & (snd_d0_transmit'=false) & (snd_d1_transmit'=false) & (snd_d2_transmit'=false);
    [t] (s_transmit=3) & ((secure_train = false) & (close_train = false) & (open_train = false)) -> (s_transmit'=3) & (snd_d0_transmit'=false) & (snd_d1_transmit'=false) & (snd_d2_transmit'=false);
endmodule
...
module recieve
    ...
    [t] (s_recieve=0) & ((secured_signal = true)) -> (s_recieve'=1) & (snd_d0_recieve'=true) & (snd_d1_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=0) & ((secured_signal = false) & (closed_crossing = true)) -> (s_recieve'=2) & (snd_d1_recieve'=true) & (snd_d0_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=0) & ((secured_signal = false) & (closed_crossing = false) & (boolOpenInput = true)) -> (s_recieve'=3) & (snd_d2_recieve'=true) & (snd_d0_recieve'=false) & (snd_d1_recieve'=false);
    [t] (s_recieve=1) & ((secured_signal = false) & (closed_crossing = true)) -> (s_recieve'=2) & (snd_d1_recieve'=true) & (snd_d0_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=2) & ((secured_signal = false) & (closed_crossing = false) & (boolOpenInput = true)) -> (s_recieve'=3) & (snd_d2_recieve'=true) & (snd_d0_recieve'=false) & (snd_d1_recieve'=false);
    [t] (s_recieve=1) & ((secured_signal = false) & (closed_crossing = false) & (boolOpenInput = true)) -> (s_recieve'=3) & (snd_d2_recieve'=true) & (snd_d0_recieve'=false) & (snd_d1_recieve'=false);
    [t] (s_recieve=1) & ((secured_signal = true)) -> (s_recieve'=1) & (snd_d0_recieve'=true) & (snd_d1_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=3) & ((secured_signal = false) & (closed_crossing = false) & (boolOpenInput = true)) -> (s_recieve'=3) & (snd_d2_recieve'=true) & (snd_d0_recieve'=false) & (snd_d1_recieve'=false);
    [t] (s_recieve=2) & ((secured_signal = false) & (closed_crossing = true)) -> (s_recieve'=2) & (snd_d1_recieve'=true) & (snd_d0_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=2) & ((secured_signal = true)) -> (s_recieve'=1) & (snd_d0_recieve'=true) & (snd_d1_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=3) & ((secured_signal = false) & (closed_crossing = true)) -> (s_recieve'=2) & (snd_d1_recieve'=true) & (snd_d0_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=3) & ((secured_signal = true)) -> (s_recieve'=1) & (snd_d0_recieve'=true) & (snd_d1_recieve'=false) & (snd_d2_recieve'=false);

    //Generated self-loops for emulating synchronous execution semantics
    [t] (s_recieve=0) & ((secured_signal = false) & (closed_crossing = false) & (boolOpenInput = false)) -> (s_recieve'=0) & (snd_d0_recieve'=false) & (snd_d1_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=1) & ((secured_signal = false) & (closed_crossing = false) & (boolOpenInput = false)) -> (s_recieve'=1) & (snd_d0_recieve'=false) & (snd_d1_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=2) & ((secured_signal = false) & (closed_crossing = false) & (boolOpenInput = false)) -> (s_recieve'=2) & (snd_d0_recieve'=false) & (snd_d1_recieve'=false) & (snd_d2_recieve'=false);
    [t] (s_recieve=3) & ((secured_signal = false) & (closed_crossing = false) & (boolOpenInput = false)) -> (s_recieve'=3) & (snd_d0_recieve'=false) & (snd_d1_recieve'=false) & (snd_d2_recieve'=false);
endmodule
